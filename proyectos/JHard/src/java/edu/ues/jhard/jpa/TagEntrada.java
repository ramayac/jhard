...
@NamedQueries({@NamedQuery(name = "TagEntrada.findAll", query = "SELECT t FROM TagEntrada t"), @NamedQuery(name = "TagEntrada.findByIdtagentrada", query = "SELECT t FROM TagEntrada t WHERE t.idtagentrada = :idtagentrada")})
