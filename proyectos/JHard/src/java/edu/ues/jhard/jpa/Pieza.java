...
@NamedQueries({
    ...
    @NamedQuery(name = "Pieza.findAllAvailable", query = "SELECT p FROM Pieza p WHERE p.idexistencia is null"),
    ...
    @NamedQuery(name = "Pieza.findByModelo", query = "SELECT p FROM Pieza p WHERE p.modelo = :modelo")})
