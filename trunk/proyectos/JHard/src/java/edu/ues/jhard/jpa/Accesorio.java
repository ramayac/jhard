...
@NamedQueries({
    ...
    @NamedQuery(name = "Accesorio.findAllAvailable", query = "SELECT a FROM Accesorio a WHERE a.idexistencia is null"),
    ...
    @NamedQuery(name = "Accesorio.findByModelo", query = "SELECT a FROM Accesorio a WHERE a.modelo = :modelo")})
